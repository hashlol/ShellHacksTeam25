...
class YouTubeSearcher:
        ...
        while True:
            ...
            if 'items' in response and len(response['items']) > 0:
                ...
                for video_id in video_ids:
                    ...
                    if video_details and YouTubeSearcher.is_duration_less_than_one_hours(video_details['contentDetails']['duration']):
    ...
    @staticmethod
    def is_duration_less_than_one_hours(duration):
        hours = 0
        minutes = 0
        if "H" in duration:
...
OpenAI = OpenAIChat(api_key_openAi)
